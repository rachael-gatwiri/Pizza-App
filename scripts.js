...
$(document).ready(function(){
  ...
  //   $("button.order").hide();
  //   $("#details").hide();
  //   $("div.whatyouordered").slideDown(1000);
  // });
...
// Add pizza button
    ...
    $("button#final-order").click(function(event){
      ...
      if ($("input#name").val() && $("input#phone").val() && $("input#location").val()!=""){
        ...
        $("#finallmessage").append(person+", We have recieved your order and it will be delivered to you at "+location+ ". send via mpesa, paybill:888888 sh. "+deliceryamount);
        $("#totalbill").hide();
